...
export default function Chart() {
    ...
    return (
        <Grid container spacing={2}>
            <Grid item md={8}>
                <Box sx={{ border: '0.5px solid', borderRadius: "5px", padding: "10px 15px", borderColor: theme.light.color4 }}>
                    <Box sx={{ marginBottom: '5px', padding: "5px", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                        <Typography variant='h5' sx={{ color: theme.light.color1, fontSize: "18px", fontWeight: 'bold' }}> Sales Analytics </Typography>
            ...
            <Grid item md={4}>
                <Box sx={{ border: '0.5px solid', borderRadius: "5px", padding: "10px 15px", borderColor: theme.light.color4 }}>
                    <Box sx={{ padding: "5px", display: "flex", justifyContent: "space-between" }}>
                        <Typography variant='h5' sx={{ color: theme.light.color1, fontSize: "18px", fontWeight: 'bold' }}> Social Source </Typography>
                        <MoreHorizIcon />
                    </Box>
